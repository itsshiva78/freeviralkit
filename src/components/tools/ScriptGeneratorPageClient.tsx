...
import { generateScriptOutline } from '@/app/actions/scripts';
import { motion, AnimatePresence } from 'framer-motion';
import { Copy, CheckCircle2, Loader2, Sparkles, RotateCcw, Clock, Video, MessageSquare } from 'lucide-react';
...
export default function ScriptGeneratorPageClient() {
