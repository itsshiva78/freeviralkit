  ...
  return (
    <>
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-display prose-headings:font-bold prose-a:text-purple-500 hover:prose-a:text-purple-600 prose-p:text-slate-600 dark:text-slate-400 dark:prose-p:text-slate-400 leading-loose">
        ...
        <p>
          To exercise any of these rights, please contact us at shivasap27sh@gmail.com. Please note that because we do not require accounts, we may not be able to identify specific data associated with you based merely on an email request, but we will do our best to assist you in compliance with applicable laws.
        </p>
        ...
        <p>
          <strong>Email:</strong> shivasap27sh@gmail.com<br />
